...
it('works as filter', () => {
	...
	testType.equal<IsNotStrictBigint<string | boolean, { selection: 'filter-unknown' }>, string | boolean>(true)
	testType.equal<IsNotStrictBigint<string | bigint, { selection: 'filter-unknown' }>, unknown>(true)
})
