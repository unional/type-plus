...
describe('exact', () => {
	...
	it('returns true if T is a template string literal reducible to simple string literal', () => {
		testType.true<IsStringLiteral<`${''}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${'b'}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${boolean}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${true}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${false}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${1}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${1.1}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${-1}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${1n}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${null}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${undefined}`, { exact: true }>>(true)

		testType.true<IsStringLiteral<`a${'b'}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${boolean}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${true}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${false}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${1}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${1.1}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${-1}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${1n}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${null}`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${undefined}`, { exact: true }>>(true)

		testType.true<IsStringLiteral<`${'b'}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${boolean}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${true}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${false}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${1}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${1.1}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${-1}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${1n}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${null}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`${undefined}c`, { exact: true }>>(true)

		testType.true<IsStringLiteral<`a${'b'}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${boolean}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${true}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${false}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${1}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${1.1}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${-1}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${1n}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${null}c`, { exact: true }>>(true)
		testType.true<IsStringLiteral<`a${undefined}c`, { exact: true }>>(true)
	})
	...
	describe('disable distribution', () => {
		...
		it('returns true if T is a template string literal', () => {
			testType.true<IsStringLiteral<`${''}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${'b'}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${boolean}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${true}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${false}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${number}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${1}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${1.1}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${-1}`, { distributive: false, exact: true }>>(true)
			testType.false<IsStringLiteral<`${string}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${bigint}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${1n}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${null}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${undefined}`, { distributive: false, exact: true }>>(true)

			testType.true<IsStringLiteral<`a${'b'}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${boolean}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${true}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${false}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${number}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${1}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${1.1}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${-1}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${string}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${bigint}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${1n}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${null}`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${undefined}`, { distributive: false, exact: true }>>(true)

			testType.true<IsStringLiteral<`${'b'}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${boolean}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${true}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${false}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${number}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${1}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${1.1}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${-1}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${string}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${bigint}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${1n}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${null}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`${undefined}c`, { distributive: false, exact: true }>>(true)

			testType.true<IsStringLiteral<`a${'b'}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${boolean}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${true}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${false}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${number}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${1}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${1.1}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${-1}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${string}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${bigint}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${1n}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${null}c`, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<`a${undefined}c`, { distributive: false, exact: true }>>(true)
		})

		it('returns true for Uppercase string literal', () => {
			testType.true<IsStringLiteral<Uppercase<'abc'>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<'foo'>, { distributive: false, exact: true }>>(true)
		})

		it('returns true for Uppercase template string literal', () => {
			testType.true<IsStringLiteral<Uppercase<`${''}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${'b'}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${boolean}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${true}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${false}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${number}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${1}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${1.1}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${-1}`>, { distributive: false, exact: true }>>(true)
			testType.false<IsStringLiteral<Uppercase<`${string}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${bigint}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${1n}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${null}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${undefined}`>, { distributive: false, exact: true }>>(true)

			testType.true<IsStringLiteral<Uppercase<`a${'b'}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${boolean}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${true}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${false}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${number}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${1}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${1.1}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${-1}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${string}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${bigint}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${1n}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${null}`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${undefined}`>, { distributive: false, exact: true }>>(true)

			testType.true<IsStringLiteral<Uppercase<`${'b'}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${boolean}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${true}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${false}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${number}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${1}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${1.1}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${-1}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${string}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${bigint}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${1n}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${null}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`${undefined}c`>, { distributive: false, exact: true }>>(true)

			testType.true<IsStringLiteral<Uppercase<`a${'b'}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${boolean}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${true}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${false}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${number}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${1}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${1.1}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${-1}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${string}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${bigint}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${1n}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${null}c`>, { distributive: false, exact: true }>>(true)
			testType.true<IsStringLiteral<Uppercase<`a${undefined}c`>, { distributive: false, exact: true }>>(true)
		})
		...
		it('returns true for Lowercase template string literal', () => {
			testType.true<IsStringLiteral<Lowercase<`${number}`>, { distributive: false, exact: true }>>(true)
