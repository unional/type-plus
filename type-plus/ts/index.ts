...
export type { ArrayType, NotArrayType } from './array/array_type.js'
...
export type * from './array/is_not_strict_array.js'
export type * from './array/is_strict_array.js'
...
export type { NotStrictArrayType, StrictArrayType } from './array/strict_array_type.js'
...
export type * from './boolean/is_not_strict_boolean.js'
export type * from './boolean/is_not_true.js'
export type * from './boolean/is_strict_boolean.js'
...
export type * from './type_plus/branch/$branch_options.js'
