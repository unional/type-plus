...
// 	testType.equal<Sum<[]>, 0>(true)
// })

// it('returns never if A is number[]', () => {
// 	testType.never<Sum<number[]>>(true)
// })

// it('returns sum of values', () => {
// 	testType.equal<Sum<[1]>, 1>(true)
// 	testType.equal<Sum<[1, 2]>, 3>(true)
// 	testType.equal<Sum<[1, 2, 3]>, 6>(true)
// })
