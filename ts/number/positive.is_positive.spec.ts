...
it('returns false if T is number as it can contain float', () => {
	type.false<IsPositive<number>>(true)
})

it('returns true if T is 0 or positive', () => {
...
it('returns false if T is a special type', () => {
	type.false<IsPositive<any>>(true)
...
it('can override Then/Else', () => {
	...
	type.equal<IsPositive<any, 1, 2>, 2>(true)
