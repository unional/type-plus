 ...
 * type R = ArrayPlus.IndexAt<['a', 'b', 'c'], 3> // undefined
 * type R = ArrayPlus.IndexAt<['a', 'b', 'c'], -4> // undefined
 * ```
 */
export type IndexAt<A extends Array<unknown>, N extends number> = Integer<
	...
	Negative<
		N,
		GreaterThan<Abs<N>, A['length']> extends true ? undefined : Subtract<A['length'], Abs<N>>,
		GreaterThan<A['length'], N> extends true ? N : undefined
	>,
	never
>
