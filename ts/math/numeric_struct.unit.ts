...
describe('BigintToMathStruct', () => {
	it('casts positive bigint to ["bigint", "+", NumberStruct]', () => {
		testType.equal<NumericStruct.FromBigint<1n>, ['bigint', '+', [[1], 0]]>(true)
	...
	it('casts 0n to ["bigint", "+", [[0]]]', () => {
		testType.equal<NumericStruct.FromBigint<0n>, ['bigint', '+', [[0], 0]]>(true)
		testType.equal<NumericStruct.FromBigint<-0n>, ['bigint', '+', [[0], 0]]>(true)
	})
})
...
describe(`NumberToMathStruct`, () => {
	it('casts positive number to ["number", "+", NumberStruct]', () => {
		testType.equal<NumericStruct.FromNumber<1>, ['number', '+', [[1], 0]]>(true)
		...
		testType.equal<NumericStruct.FromNumber<0.0>, ['number', '+', [[0], 0]]>(true)
		testType.equal<NumericStruct.FromNumber<0.1>, ['number', '+', [[1], 1]]>(true)
		testType.equal<NumericStruct.FromNumber<0.1>, ['number', '+', [[1], 1]]>(true)
		testType.equal<NumericStruct.FromNumber<1.0>, ['number', '+', [[1], 0]]>(true)
		testType.equal<NumericStruct.FromNumber<1.0>, ['number', '+', [[1], 0]]>(true)
		testType.equal<NumericStruct.FromNumber<1.1>, ['number', '+', [[1, 1], 1]]>(true)
		testType.equal<NumericStruct.FromNumber<1.1>, ['number', '+', [[1, 1], 1]]>(true)

		testType.equal<NumericStruct.FromNumber<0.123>, ['number', '+', [[1, 2, 3], 3]]>(true)
		testType.equal<NumericStruct.FromNumber<0.000123>, ['number', '+', [[1, 2, 3], 6]]>(true)
		testType.equal<NumericStruct.FromNumber<123.45>, ['number', '+', [[1, 2, 3, 4, 5], 2]]>(true)
	})
	...
	it('casts 0n to ["number", "+", [[0], 0]]', () => {
		testType.equal<NumericStruct.FromNumber<0>, ['number', '+', [[0], 0]]>(true)
		testType.equal<NumericStruct.FromNumber<-0>, ['number', '+', [[0], 0]]>(true)
	})

	it('casts floating point numbers with correct exponent', () => {
		testType.equal<NumericStruct.FromNumber<1.1>, ['number', '+', [[1, 1], 1]]>(true)
		testType.equal<NumericStruct.FromNumber<1.2345>, ['number', '+', [[1, 2, 3, 4, 5], 4]]>(true)
		testType.equal<NumericStruct.FromNumber<123.45>, ['number', '+', [[1, 2, 3, 4, 5], 2]]>(true)
	...
	it('normalizes floating point numbers', () => {
		testType.equal<NumericStruct.FromNumber<0.1>, ['number', '+', [[1], 1]]>(true)
		testType.equal<NumericStruct.FromNumber<0.1357>, ['number', '+', [[1, 3, 5, 7], 4]]>(true)
		testType.equal<NumericStruct.FromNumber<0.00123>, ['number', '+', [[1, 2, 3], 5]]>(true)
		testType.equal<NumericStruct.FromNumber<0.009753>, ['number', '+', [[9, 7, 5, 3], 6]]>(true)
...
describe(`NormalizedMathStructToNumeric`, () => {
	it('converts bigint', () => {
		testType.equal<NumericStruct.NormalizedToNumeric<['bigint', '+', [[0], 0]]>, 0n>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['bigint', '+', [[1], 0]]>, 1n>(true)
		testType.equal<
			NumericStruct.NormalizedToNumeric<['bigint', '+', [[9, 8, 7, 6, 5, 4, 3, 2, 1, 0], 0]]>,
			9876543210n
		>(true)
	...
	it('converts whole numbers', () => {
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[0], 0]]>, 0>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1], 0]]>, 1>(true)
		testType.equal<
			NumericStruct.NormalizedToNumeric<['number', '+', [[9, 8, 7, 6, 5, 4, 3, 2, 1, 0], 0]]>,
			9876543210
		>(true)
		testType.equal<
	...
	it('converts floating point numbers', () => {
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1], 1]]>, 0.1>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1, 2], 1]]>, 1.2>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1, 2, 3], 1]]>, 12.3>(true)

		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1, 2, 3, 4, 5], 1]]>, 1234.5>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1, 2, 3, 4, 5], 2]]>, 123.45>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1, 2, 3, 4, 5], 3]]>, 12.345>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1, 2, 3, 4, 5], 4]]>, 1.2345>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1, 2, 3, 4, 5], 5]]>, 0.12345>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1, 2, 3, 4, 5], 6]]>, 0.012345>(
			true
		)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '+', [[1, 2, 3, 4, 5], 7]]>, 0.0012345>(
			true
		)
		...
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '-', [[1, 2, 3, 4, 5], 3]]>, -12.345>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '-', [[1, 2, 3, 4, 5], 4]]>, -1.2345>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '-', [[1, 2, 3, 4, 5], 5]]>, -0.12345>(
			true
		)
		testType.equal<NumericStruct.NormalizedToNumeric<['number', '-', [[1, 2, 3, 4, 5], 6]]>, -0.012345>(
			true
	...
	it('converts bigint with floating point number to number', () => {
		testType.equal<NumericStruct.NormalizedToNumeric<['bigint', '+', [[1, 2, 3, 4, 5], 3]]>, 12.345>(true)
		testType.equal<NumericStruct.NormalizedToNumeric<['bigint', '+', [[1, 2], 4]]>, 0.0012>(true)
...
describe('Normalize', () => {
	it('remain unchanged if every digits are single digits for bigint', () => {
		...
		testType.equal<
			NumericStruct.Normalize<['bigint', '+', [[1, 2, 3], 0]]>,
			['bigint', '+', [[1, 2, 3], 0]]
		>(true)
		testType.equal<
			NumericStruct.Normalize<['bigint', '+', [[1, 2, 3], 1]]>,
			['bigint', '+', [[1, 2, 3], 1]]
		>(true)
		testType.equal<
