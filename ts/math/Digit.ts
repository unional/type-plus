...
export namespace DigitArray {
	...
	export type Shift10State<R extends number[], DA extends number[]> = DA['length'] extends 0
		? R
		: DA['length'] extends 1
		? [...R, ...DA]
	...
	export type TrimLeadingZero<A extends number[]> = A['length'] extends 0
		? A
		: A[0] extends 0
		? TrimLeadingZero<Tail<A>>
		: A
